      ...
      <div className="flex h-full w-12 flex-col items-center border-r bg-muted/50 py-2">
        ...
        <div className="flex flex-col items-center gap-1 pb-1">
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              {daemonStatus === "running" && "采集服务运行中"}
              {daemonStatus === "starting" && "采集服务启动中..."}
              {daemonStatus === "port_conflict" && "19827 端口被占用，网页采集暂不可用。"}
              {daemonStatus === "error" && "采集服务异常，正在重启..."}
            </TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger
