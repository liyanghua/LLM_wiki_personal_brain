...
#[tauri::command]
fn get_runtime_env(name: String) -> Option<String> {
    std::env::var(name)
        .ok()
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pdf_backend::analyze_pdf_with_backend,
            commands::document_backend::analyze_document_with_backend,
            commands::document_backend::convert_doc_to_docx,
            commands::personal_brain::ensure_project_brain_binding,
            commands::personal_brain::generate_strategy_skill_candidates,
            commands::personal_brain::approve_strategy_skill,
            commands::personal_brain::run_project_agent,
            set_proxy_env,
            get_runtime_env,
        ])
