...
pub struct StrategySkillCandidateManifestResult {
    ...
    pub origin_action_card_ids: Vec<String>,
...
pub struct ApprovedSkillSpecResult {
    ...
    pub execution_spec: serde_json::Value,
}
...
pub struct AgentRunResultPayload {
    ...
    pub execution_timeline: Vec<serde_json::Value>,
    pub degradation_reason: Option<serde_json::Value>,
    pub step_executions: Vec<serde_json::Value>,
